...
{
    /// <summary>
    /// Ô chọn skin bóng trong màn <see cref="CustomizationUI"/> (prefab <c>BallSkinCellView</c>).
    /// Chưa mua thì làm xám; đang trang bị thì đổi nền và bật vầng sáng.
    /// </summary>
    public class BallSkinCellView : MonoBehaviour
    {
        /// <summary>Ảnh quả bóng (node <c>BG/BallImage</c>).</summary>
        [Header("UI Components")]
        [SerializeField] private Image ballImage;

        /// <summary>Nút chọn (node <c>BG - ShineEffect</c>).</summary>
        ...
        /// <summary>Vầng sáng nền (node <c>BG - ShineEffect/Image - BGglow</c>).</summary>
        [Header("BGglow")]
        ...
        /// <summary>Phát khi người chơi bấm chọn ô; tham số là chỉ số skin trong <see cref="Shop.ballsList"/>.</summary>
        ...
        /// <summary>
        /// Gắn một skin bóng vào ô.
        /// </summary>
        /// <param name="item">Skin bóng cần hiển thị; null sẽ ẩn ô.</param>
        /// <param name="index">Chỉ số skin trong <see cref="Shop.ballsList"/>.</param>
        /// <param name="purchased">True khi người chơi đã sở hữu skin.</param>
        /// <param name="equipped">True khi skin đang được trang bị.</param>
        public void Bind(BallShopItem item, int index, bool purchased, bool equipped)
        {
            Wire();
            ...
            // Không nhuộm ảnh theo trailColor: màu đó dành cho vệt bay của bóng trong trận,
            // áp lên icon sẽ sai màu so với art gốc.
            if (ballImage != null)
            {
                if (item.icon != null) ballImage.sprite = item.icon;
        ...
        private void Wire()
        {
            ...
            if (selectButton != null) selectButton.onClick.AddListener(SelectBall);
        }
        ...
        {
            if (selectButton != null) selectButton.onClick.RemoveListener(SelectBall);
            OnSelected = null;
        }
    }
}
